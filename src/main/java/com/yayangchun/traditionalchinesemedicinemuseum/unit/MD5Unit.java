...
public class MD5Unit {
    ...
    public static String md5PlusSalt(String keyword)
    {
        ...
        String digestHex = md5.digestHex(keyword);
        //md5+盐
        char[] cArray = digestHex.toCharArray();
...
//        String md5salt= MD5Unit.md5PlusSalt(keyword);
//        System.out.println("加盐后："+"\n"+md5salt);
//        String word= MD5Unit.md5MinusSalt(md5salt);
//        System.out.println("解密后："+"\n"+word);

//        String aaa= DigestUtils.md5Hex("123456" + UUID.randomUUID());
//
